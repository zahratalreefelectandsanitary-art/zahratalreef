        ...
        <div className="container mx-auto px-6 lg:px-32">
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="text-sm mb-6 lg:mb-0">
              ...
              <p className=''>©2026 all rights reserved. Designed by <a href="https://www.instagram.com/tri._design?igsh=MXMyNHVvb2Q5Z3U2eA==" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">TRIDezign</a></p>
            </div>
