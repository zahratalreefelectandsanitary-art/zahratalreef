...
const Fittings = () => {
    ...
    const products = [
        { images: ["fittings.jpg"], name: "fittings" },
        { images: ["fittings2.jpg"], name: "fittings" },
        { images: ["fittings3.jpg"], name: "fittings" },
        { images: ["fittings4.jpg"], name: "fittings" },
    ...
    "Explore our reliable fittings, designed to ensure secure and seamless connections for every project."
</p>


                </div>

                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 px-4 max-w-screen-lg mx-auto">
