...
const Others = () => {
    ...
    const products = [
        { images: ["other1.jpg"], name: "others" },
        { images: ["other2.jpg"], name: "others" },
        { images: ["other3.jpg"], name: "others" },
        { images: ["other4.jpg"], name: "others" },
        { images: ["other14.jpg"], name: "others" },
        { images: ["other6.jpg"], name: "others" },
        { images: ["other9.jpg"], name: "others" },
       
        { images: ["other8.jpg"], name: "others" },
        { images: ["other10.jpg"], name: "others" },
        { images: ["other13.jpg"], name: "others" },
    
        { images: ["other11.jpg"], name: "others" },
        { images: ["other12.jpg"], name: "others" },
    ...
    "Discover our diverse range of essential products,  water heaters , paints, gypsum ceiling tiles, and uPVC pipes , PRP pipes and fittings all crafted for quality and durability."
</p>
                ...
                <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 gap-4 px-4 max-w-screen-lg mx-auto">
                    {products.map((product, index) => (
                        <div
                            ...
                            data-aos="zoom-in"
                            data-aos-delay={`${ index * 100}`} // Incremental delay for each product
                        >
                            <img
            ...
            <div className="bg-blue text-white py-10">
                <div className="max-w-6xl mx-auto px-4">
                    <div className="grid gap-x-4 md:gap-x-8 gap-y-4 grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 text-center">
                        {["RAKTHERN","COSMOPLAST","NATIONAL","STAR","ARISTON","ZENITH","SUNEX","MILANO"].map((brand, index) => (
                            <div
                                key={index}
