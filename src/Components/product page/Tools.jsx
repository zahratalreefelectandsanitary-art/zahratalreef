...
const Tools = () => {
    ...
    const products = [
        ...
        { images: ["tools3.jpg"], name: "Tools" },
        { images: ["tools2.jpg"], name: "Tools" },
        { images: ["tools15.jpg"], name: "Tools" },
        { images: ["tools4.jpg"], name: "Tools" },
        { images: ["tools17.jpg"], name: "Tools" },
        { images: ["tools6.jpg"], name: "Tools" },
        { images: ["tools7.jpg"], name: "Tools" },
        { images: ["tools8.jpg"], name: "Tools" },
        { images: ["tools9.jpg"], name: "Tools" },
        { images: ["tools10.jpg"], name: "Tools" },
        { images: ["tools1.jpg"], name: "Tools" },
        { images: ["tools12.jpg"], name: "Tools" },
    ];
            ...
            >
                ...
                >
                    ...
                    <p className="mt-2 text-sm md:text-base text-gray-600">
                        "Find our versatile range of tools, crafted for precision and durability to meet every challenge."
                    </p>
