...
const Pipes = () => {
    ...
    const products = [
        { images: ["pipes1.jpg"], name: "pipes" },
        { images: ["pipes2.jpg"], name: "pipes" },
        { images: ["pipes3.jpg"], name: "pipes" },
        { images: ["pipes4.jpg"], name: "pipes" },
        { images: ["pipes6.jpg"], name: "pipes" },
        { images: ["pipes7.jpg"], name: "pipes" },
        { images: ["pipes8.jpg"], name: "pipes" },
        { images: ["pipes10.jpg"], name: "pipes" },
            ...
            >
                ...
                >
                    ...
                    <p className="mt-2 text-sm md:text-base text-gray-600">
                        "Discover our durable pipes, engineered for long-lasting performance and versatility across all applications."
                    </p>
