...
const Ironmongery = () => {
    ...
    const products = [
        { images: ["iron1.jpg"], name: "ironmongery" },
        { images: ["iron2.jpg"], name: "ironmongery" },
        { images: ["iron3.jpg"], name: "ironmongery" },
        { images: ["iron6.jpg"], name: "ironmongery" },
        { images: ["iron4.jpg"], name: "ironmongery" },
        { images: ["iron5.jpg"], name: "ironmongery" },
        { images: ["iron7.jpg"], name: "ironmongery" },
        { images: ["iron8.jpg"], name: "ironmongery" },
        { images: ["iron9.jpg"], name: "ironmongery" },
        { images: ["iron10.jpg"], name: "ironmongery" },
        { images: ["iron11.jpg"], name: "ironmongery" },
        { images: ["iron12.jpg"], name: "ironmongery" },
            ...
            >
                ...
                >
                    ...
                    <p className="mt-2 text-sm md:text-base text-gray-600">
                        "Discover our premium ironmongery collection, offering strength and style for all your construction needs."
                    </p>
            ...
            <div className="bg-blue text-white py-10">
                <div className="max-w-6xl mx-auto px-4">
                    <div className="grid gap-x-4 md:gap-x-8 gap-y-4 grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 text-center">
                        {["UNION ASSA ABLOY","YALE","CYLINK","AKADAISEO","EUROART","ROMAX","DOGANLAR","COLADO VAENCIA" ].map((brand, index) => (
                            <div
                                key={index}
